            ...
            return Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                          decoration:
                              SmallWidgets.inputDecoration("Должность"),
  ...
  Future<void> _function(BuildContext context) {
    return Future.sync(
        ...
        .whenComplete(() => Future.sync(() => context
                ...
                .add(VacanciesCompanyEvent.addOrDeleteLocalVacancy(nameVacancy: vacancyName, delete: true)))
