...
FeedbackVacancyNoSubscribe _$FeedbackVacancyNoSubscribeFromJson(
    Map<String, dynamic> json) {
  return FeedbackVacancyNoSubscribe(
    json['id'] as int,
    json['vacancy_id'] as int,
    json['resume_id'] as int,
    json['expires_at'] as String?,
...
Map<String, dynamic> _$FeedbackVacancyNoSubscribeToJson(
        FeedbackVacancyNoSubscribe instance) =>
    <String, dynamic>{
      'id': instance.id,
      'vacancy_id': instance.vacancy_id,
      'resume_id': instance.resume_id,
